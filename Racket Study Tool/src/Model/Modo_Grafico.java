...
public class Modo_Grafico {
    ...
    public String Graficos(){
        String data =   "La gran mayoria de lenguajes de programacion nos ofrece un modo grafico o un \n" +
                        "conjunto de instrucciones y/o funciones que permiten usar ventanas, pixeles,   \n" +
                        "multimedia y raton, con el fin de desarrollar programas en modo grafico. \n";
        return data;
    }
