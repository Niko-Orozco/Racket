 ...
 * @author xlOnly
 */
public class ExprionesView extends javax.swing.JFrame {

    /**
     * Creates new form ExprionesView
     */
    public ExprionesView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExprionesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExprionesView().setVisible(true);
            }
        });
    }
